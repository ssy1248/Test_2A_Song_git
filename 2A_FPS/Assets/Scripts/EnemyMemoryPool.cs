...
public class EnemyMemoryPool : MonoBehaviour
{
    ...
    [SerializeField]
    private float enemySpawnLatency = 1; //타일 생성 후 적이 등장하기까지 대기

    private MemoryPool spawnPointMemoryPool; //적 등장 위치를 알려주는 오브젝트 생성
    private MemoryPool enemyMemoryPool; //적 생성, 활성/비활성화관리
